...
int privnet_local_access_ingress_from_netdev_setup(struct __ctx_buff *ctx)
{
	...
	privnet_v4_add_subnet_route(NET_ID, SUBNET_ID, V4_NET_IP_1, V4_PRIVNET_KEY_LEN, GATEWAY_IP,
				    IFINDEX);
...
int privnet_local_access_ingress_from_netdev_check(struct __ctx_buff *ctx)
{
	...
	privnet_v4_del_route(NET_ID, SUBNET_ID, V4_NET_IP_1, V4_PRIVNET_KEY_LEN);
