...
func (in *BGPASPathPrepend) DeepEqual(other *BGPASPathPrepend) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *BGPVRFReference) DeepEqual(other *BGPVRFReference) bool {
	if other == nil {
		return false
	}
...
func (in *IsovalentBGPInstance) DeepEqual(other *IsovalentBGPInstance) bool {
	...
	if (in.VRFRef == nil) != (other.VRFRef == nil) {
		...
		if !in.VRFRef.DeepEqual(other.VRFRef) {
			return false
		}
	}
