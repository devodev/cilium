...
```
  ...
  -h, --help                                                                help for hive
      ...
      --private-networks-auto-external-endpoints-config-dir string          Configuration for the creation of PrivateNetworkExternalEndpoints (default "/var/lib/cilium/privnet/auto-external-endpoints-config")
      --private-networks-auto-external-endpoints-enabled                    Automatically create PrivateNetworkExternalEndpoints
      --private-networks-auto-external-endpoints-secrets-namespace string   Kubernetes namespace from which provider secrets are read (default "cilium-secrets")
