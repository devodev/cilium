...
.. list-table::
   ...
   * - :spelling:ignore:`envoy.affinity`
     ...
     - object
     - ``{"nodeAffinity":{"requiredDuringSchedulingIgnoredDuringExecution":{"nodeSelectorTerms":[{"matchExpressions":[{"key":"cilium.io/no-schedule","operator":"NotIn","values":["true"]}]}]}},"podAffinity":{"requiredDuringSchedulingIgnoredDuringExecution":[{"labelSelector":{"matchLabels":{"k8s-app":"cilium"}},"topologyKey":"kubernetes.io/hostname"}]},"podAntiAffinity":{"preferredDuringSchedulingIgnoredDuringExecution":[{"podAffinityTerm":{"labelSelector":{"matchLabels":{"k8s-app":"cilium-envoy"}},"topologyKey":"kubernetes.io/hostname"},"weight":100}],"requiredDuringSchedulingIgnoredDuringExecution":[]}}``
   ...
   * - :spelling:ignore:`hubble.timescape.clickhouse.configMap.labels`
     ...
     - object
     - ``{}``
   * - :spelling:ignore:`hubble.timescape.clickhouse.extraVolumeMounts`
     - Extra volume mounts for the Hubble Timescape Clickhouse container
     - list
     - ``[]``
   ...
   * - :spelling:ignore:`hubble.timescape.extraEnv`
     ...
     - list
     - ``[]``
   * - :spelling:ignore:`hubble.timescape.extraVolumeMounts`
     - Extra volume mounts for the Hubble Timescape container
     - list
     - ``[]``
   * - :spelling:ignore:`hubble.timescape.extraVolumes`
     - Extra volumes for the Hubble Timescape pod
     - list
     - ``[]``
   * - :spelling:ignore:`hubble.timescape.grafana`
     - Optional ConfigMap with Grafana dashboards for Hubble Timescape. Grafana can import dashboards based on the labels. ref: https://github.com/grafana/helm-charts/tree/main/charts/grafana#sidecar-for-dashboards
     - object
     - ``{"dashboards":{"annotations":{},"enabled":false,"labels":{"grafana_dashboard":"1"},"namespace":null}}``
   * - :spelling:ignore:`hubble.timescape.grafana.dashboards.annotations`
     - Annotations to add to the ConfigMap.
     - object
     - ``{}``
   * - :spelling:ignore:`hubble.timescape.grafana.dashboards.labels`
     - Labels to add to the ConfigMap. If using the dashboards sidecar, they must include the label used to discover dashboards.
     - object
     - ``{"grafana_dashboard":"1"}``
   * - :spelling:ignore:`hubble.timescape.grafana.dashboards.namespace`
     - Namespace to create the ConfigMap in. Defaults to namespace of the helm release. @schema type: [null, string] @schema
     - string
     - ``nil``
